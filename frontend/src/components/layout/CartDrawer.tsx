      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
        ...
        {cart.length > 0 && (
          <div className="p-6 border-t border-border space-y-4 bg-ivory">
            ...
            <p className="text-[10px] text-muted-foreground italic text-center">Place your order directly via WhatsApp.</p>
            <button 
              onClick={handleWhatsAppOrder}
              className="w-full bg-[#25D366] text-white flex items-center justify-center space-x-3 py-4 font-bold tracking-[0.2em] uppercase text-sm hover:opacity-90 transition-all shadow-lg"
            >
